  ...
  const journeyData: JourneyItem[] = [
    {
      ...
      description:
        "Developing and maintaining end-to-end web solutions for digital banking products, delivering secure, high-performance, and user-friendly experiences.",
      achievements: [
        "Built and maintained production-ready fullstack web features",
        "Collaborated across teams to deliver reliable banking experiences",
        "Improved application performance and usability",
        "Implemented scalable frontend and backend solutions",
      ],
    ...
    },
    {
      ...
      year: "2025 - 2026",
      title: "Fullstack Web Developer",
      company: "Ministry of Inspection",
      location: "Phnom Penh, Cambodia",
      description:
        "Delivered fullstack web solutions for internal and public-facing platforms, focusing on usability, maintainability, and stable delivery.",
      achievements: [
        "Built web features using Laravel and Vue",
        "Styled and maintained responsive UI with Tailwind CSS",
        "Developed and maintained content-driven sites with WordPress",
        "Collaborated with stakeholders to deliver practical digital solutions",
      ],
      technologies: ["Laravel", "Vue", "Tailwind CSS", "WordPress"],
      type: "work",
      icon: Code,
